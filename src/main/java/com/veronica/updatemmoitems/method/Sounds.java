...
public class Sounds {
    ...
    public static void playSuccessSound(Player player, String soundKey, float volume, float pitch) {
    ...
    public static void playFailSound(Player player, String soundKey, float volume, float pitch) {
        if (soundKey != null && !soundKey.isEmpty()) {
            try {
                Sound sound = Sound.valueOf(soundKey);
                player.playSound(player.getLocation(), sound, volume, pitch);
